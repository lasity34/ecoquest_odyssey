...
window.addEventListener('DOMContentLoaded', function () {
    ...
    var createScene = function () {
        ...
        var createTree = function (scene, x, z, treeName) {
            ...
            leaves.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, function () {
                console.log("leaves clicked:", treeName); // Check if this logs
