window.addEventListener('DOMContentLoaded', function () {
    ...
    var createScene = function () {
        ...
        function updateEnvironment() {
            correctAnswers++; // Increment correct answers, replace with actual game logic
        ...
        // Simulate answer checking for demonstration
        setInterval(updateEnvironment, 3000); // Call every 3 seconds
