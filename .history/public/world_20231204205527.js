window.addEventListener('DOMContentLoaded', function () {
    ...
    var createScene = function () {
        ...
        // Dummy data for correct answers
        var correctAnswers = 0; // Initialize correct answers count
        ...
        // Click event to simulate correct answer
        window.addEventListener('click', function () {
            correctAnswers++; // Increment correct answers on click
            updateEnvironment(); // Update the environment
        });
        ...
        // Make all trees, mountains, and lakes clickable
