...
window.addEventListener('DOMContentLoaded', function () {
    ...
    var createScene = function () {
        ...
        var createTree = function (scene, x, z, treeName) {
            ...
            var testMesh = BABYLON.MeshBuilder.CreateSphere("testSphere", {diameter: 2}, scene);
            testMesh.position = new BABYLON.Vector3(0, 1, 0);
            testMesh.actionManager = new BABYLON.ActionManager(scene);
            testMesh.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, function () {
