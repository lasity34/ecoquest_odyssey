...
window.addEventListener("DOMContentLoaded", function() {
  ...
  var scene = createScene(engine, canvas); // Create the scene
  updateEnvironment(scene); // Update the environment
  ...
  // Additional logic (like handling correct answers) can be added here
  // ...
});